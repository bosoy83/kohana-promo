...
class Controller_Admin_Modules_Promo_Element extends Controller_Admin_Modules_Promo {
	...
	public function action_index()
	{
		...
		$this->template
			->set_filename('modules/promo/element/list')
			->set('list', $list)
	...
	public function action_edit()
	{
		...
		$helper_orm = ORM_Helper::factory('promo');
		$orm = $helper_orm->orm();
		if ( (bool) $id) {
			$orm
				->where('id', '=', $id)
			...
			$this->title = __('Edit banner');
		} else {
			$this->title = __('Add banner');
		}
		...
		if ( ! empty($errors) OR $submit != 'save_and_exit') {
			$field_hints = Kohana::$config->load('promo.field_hints');
			$this->template
				->set_filename('modules/promo/element/edit')
				->set('errors', $errors)
				->set('helper_orm', $helper_orm)
				->set('field_hints', $field_hints);
	...
	public function action_view()
	{
		...
		$this->template
			->set_filename('modules/promo/element/view')
			->set('helper_orm', $helper_orm);
